...
struct Color {
    ...
    Color& operator*=(float factor) {
        r = std::clamp(static_cast<Uint8>(r * factor), Uint8(0), Uint8(255));
        g = std::clamp(static_cast<Uint8>(g * factor), Uint8(0), Uint8(255));
        b = std::clamp(static_cast<Uint8>(b * factor), Uint8(0), Uint8(255));
        a = std::clamp(static_cast<Uint8>(a * factor), Uint8(0), Uint8(255));
        return *this;
    }
